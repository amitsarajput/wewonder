<div class="line project-<?= $mglink; ?> line<?= $line; ?>" data-class="<?= $line; ?>">
    <div class="has_img">
        <img src="assets/img/load.webp" data-mobile="assets/img/bg/m13.jpg" data-src="assets/img/bg/13.jpg">
    </div>
    <div class="small_msg">
        <div class="tab">
            <div class="pops">
    ...
    <div class="content">
        <div class="subdata">
            ...
            <img src="assets/img/load.webp" data-src="assets/img/westwood/westwood-group-banner1.jpg" class="topimg">
            <div class="cnt">
