<div class="line project-<?= $mglink; ?> hidden-force line<?= $line; ?>" data-class="<?= $line; ?>">
    <div class="has_img">
        <img src="assets/img/load.webp" data-src="assets/img/bg/13.jpg">
    </div>
    <div class="small_msg">
        <div class="tab">
            <div class="pops">
                <div>
                    <h2>Westwood Group</h2>
                    <p class="first">User Interface</p>
                    <p>Indentity System Design</p>
                    <a href="<?= $url.$mglink; ?>">See Project <span></span></a>
                </div>
            </div>
        </div>
    </div>
    <div class="content">
        <div class="subdata">
            <div class="row data">
                <div class="clearfix">
                    <div class="col rightb anim1">
                        <h2>Westwood Group</h2>
                        <p>User Interface</p>
                        <p>Indentity System Design</p>
                    </div>
                    <div class="col rightb anim2">
                        <p><b>Client: </b>Westwood Group, Texas</p>
                        <p><b>Product: </b>-</p>
                        <p><b>Year: </b>2016 – Present</p>
                    </div>
                    <div class="col moredata anim3">
                        <div class="clearfix">
                            <div class="col">
                                <p><b>DELIVERABLES</b></p>
                                <p>Visual Communication</p>
                                <p>Presentations</p>
                                <p>Corporate Collaterals</p>
                            </div>
                            <div class="col">
                                <p>Print Adverts</p>
                                <p>Identity Design</p>
            ...
            <img src="assets/img/load.webp" data-src="assets/img/westwood/westwood-group-banner.jpg" class="topimg">
            <div class="cnt">
                ...
                <div class="anchor">
                    <div class="clearfix">
                        ...
                        <a href="#" class="right wow fadeInRight">
                            <span></span>
                            <b>Westwood Group</b>
                            <p>User Interface<br>Identity System Design</p>
                        </a>
                ...
                <div class="b_copy wow fadeIn">
                    <p>Copyright © 2020 WeWonder Global</p>
                </div>
            </div>
        </div>
    </div>
