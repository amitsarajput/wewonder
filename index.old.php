...
$pages = array('home', 'about', 'work', 'services', 'leadership', 'contact');
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/app.css?<?= $cachetype; ?>">
    ...
    <script src="assets/js/app.js?<?= $cachetype; ?>"></script>
